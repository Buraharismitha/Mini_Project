...
def run_decision_tree():
    ...
    text.insert(END, "Decision Tree Accuracy: " + str(accuracy*100) + "\n")
    return accuracy
...
def run_random_forest():
    ...
    text.insert(END, "Random Forest Accuracy: " + str(accuracy*100) + "\n")
    return accuracy
...
def run_knn():
    ...
    text.insert(END, "K-Nearest Neighbors Accuracy: " + str(accuracy*100) + "\n")
    return accuracy
...
def run_naive_bayes():
    ...
    text.insert(END, "Naive Bayes Accuracy: " + str(accuracy*100) + "\n")
    return accuracy
...
predictButton.place(x=1250, y=650)
